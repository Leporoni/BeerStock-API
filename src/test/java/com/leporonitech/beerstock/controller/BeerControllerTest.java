...
import com.leporonitech.beerstock.builder.BeerDTOBuilder;
...
import static com.leporonitech.beerstock.utils.JsonConvertionUtils.asJsonString;
...
public class BeerControllerTest {
    ...
    void whenPOSTIsCalledThenABeerIsCreated() throws Exception {
        ...
        mockMvc.perform(post(BEER_API_URL_PATH)
                        ...
                        .content(asJsonString("$.type", beerDTO)))
                .andExpect(status().isCreated())
                .andExpect(asJsonString("$.name", beerDTO.getName()))
                .andExpect(asJsonString("$.brand", beerDTO.getBrand()))
                .andExpect(asJsonString("$.type", beerDTO.getType().toString()));
    }
    ...
    void whenPATCHIsCalledToIncrementDiscountThenOKstatusIsReturned() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.patch(BEER_API_URL_PATH + "/" + VALID_BEER_ID + BEER_API_SUBPATH_INCREMENT_URL)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(asJsonString("$.type", quantityDTO))).andExpect(status().isOk())
